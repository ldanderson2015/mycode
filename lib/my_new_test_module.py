...
def run_module():
    ...
    if module.params['age'] == 37:
        result['message'] = module.params['name'] + " isn't old, they're 37!"
    else:
        result['message'] = str(module.params['age'])

    if module.params['name'].lower() == 'arthur':
        result['message'] += " Who elected YOU King?!"
    elif module.params['name'].lower() == 'dennis':
        result['message'] += " Help! Help! I'm being repressed! Come see the violence inherent in the system!"
